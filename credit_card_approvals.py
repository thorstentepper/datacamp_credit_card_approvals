...
# Count the number of NaNs in the dataset to verify the result.
cc_apps.isnull().sum()
...
### Making predictions and evaluation performance
...
### Grid searching and improving model performance
# Import GridSearchCV.
